...
echo ""
echo -e "  ${YELLOW}Note:${NC} The app says \"Revolt\" — that's normal. Stoat was previously called"
echo -e "  Revolt before a rebrand in late 2025. The web client hasn't been updated"
